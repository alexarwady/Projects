...
$sql = "SELECT DISTINCT a.row1, a.column1, a.username, b.firstname, b.lastname FROM schedule AS a, users AS b WHERE a.username=b.username";
$result = $conn->query($sql);
while($row = $result->fetch_assoc())
{
    $movies[$row["row1"]][$row["column1"]] = $row["firstname"]." ".$row["lastname"]."\n".$movies[$row["row1"]][$row["column1"]];
}
