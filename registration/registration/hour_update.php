...
<form method="post" action="">
    ...
    <div class="input-group">
        <label>Date</label>
        <input type="date" name="datetime" value="<?php echo htmlspecialchars($date3);?>" readonly>
    </div>
    <div class="input-group">
        <label>Start Time</label>
        <input type="time" name="starttime" value="<?php echo htmlspecialchars($start2[0]);?>" readonly>
    </div>
    <div class="input-group">
        <label>End Time</label>
        <input type="time" name="endtime" value="<?php echo $today_time;?>" readonly>
    </div>
    <div class="input-group">
